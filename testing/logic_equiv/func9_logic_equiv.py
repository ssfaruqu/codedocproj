...
pass_arr = [0,0,0,0,0]
pass_arr[0] = try_test(test_para_flat_func9, "PARA FLAT FAIL", "PARA FLAT PASS")
pass_arr[1] = try_test(test_para_struc_func9, "PARA STRUC FAIL", "PARA STRUC PASS")
pass_arr[2] = try_test(test_bullet_flat_func9, "BULLET FLAT FAIL", "BULLET FLAT PASS")
pass_arr[3] = try_test(test_bullet_struc_func9, "BULLET STRUC FAIL", "BULLET STRUC PASS")
pass_arr[4] = try_test(test_psuedo_func9, "PSUEDO FAIL", "PSUEDO PASS")
